...
"""
        ...
        return [
            UserMessage(system_content),
            AssistantMessage("I'll help you create a balanced meal plan! Let me start by checking what recipes are available in your Mealie database."),
