...
from .comments_tools import register_comments_tools
...
from .organizer_tools_tools import register_organizer_tools_tools
...
def register_all_tools(mcp, mealie):
    ...
    register_organizer_tools_tools(mcp, mealie)
    register_cookbooks_tools(mcp, mealie)
    register_comments_tools(mcp, mealie)
...
__all__ = [
    ...
    "register_organizer_tools_tools",
    "register_cookbooks_tools",
    "register_comments_tools",
