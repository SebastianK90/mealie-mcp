...
def register_shopping_list_tools(mcp: FastMCP, mealie: MealieFetcher) -> None:
    ...
    def create_shopping_list_items_bulk(
        ...
        Args:
            items: List of item dictionaries, each containing:
                ...
                - unitId (str, optional): UUID of the unit
                - foodId (str, optional): UUID of the food
                - labelId (str, optional): UUID of the label
    ...
    def update_shopping_list_item(
        ...
        """Update a shopping list item. Use this to check/uncheck items, modify their details, or assign a label.

        Works safely on all items including recipe-linked ones (recipe references are preserved via fetch-merge).
        ...
        Args:
            ...
            label_id: UUID of the label to assign (use get_labels to find label IDs)
    ...
    def update_shopping_list_items_bulk(
        ...
        Each item dict needs an "id" key plus only the fields you want to change.
        Works safely on all items including recipe-linked ones (recipe references
        are preserved via fetch-merge).

        Example: [{"id": "abc-123", "labelId": "label-456"}, ...]

        Args:
            items: List of item dicts, each with "id" and fields to update
